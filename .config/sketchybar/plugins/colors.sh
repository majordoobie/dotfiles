...
export BLUE=$CATPPUCCIN_MOCHA_BLUE
export RED=$CATPPUCCIN_MOCHA_RED
export ORANGE=$CATPPUCCIN_MOCHA_PEACH
export YELLOW=$CATPPUCCIN_MOCHA_YELLOW
export WHITE_TEXT=$CATPPUCCIN_MOCHA_TEXT
export BLACK_TEXT=$CATPPUCCIN_MOCHA_CRUST
